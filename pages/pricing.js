...
export default function Pricing() {
  return (
    <div className={styles.shapedContainer}>
        ...
        <div className={styles.cardContainer}>
          <div className={styles.card}>
            ...
            <p>
              ...
              aperiam quasi in animi consequuntur, error saepe pariatur
              accusamus dolores ipsa atque sint deleniti. Quidem asperiores
              ipsum debitis nihil non tempora! Consectetur quia eligendi natus
              sint vero fugit ducimus corporis, nam distinctio excepturi
              accusantium molestiae, ipsam animi, soluta quasi delectus beatae.
            </p>
          ...
          <div className={styles.card}>
            ...
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed
              aperiam quasi in animi consequuntur, error saepe pariatur
              accusamus dolores ipsa atque sint deleniti.
            </p>
            <ul>
              <li>
